	...
	public static void main(String[] args) {
		...
		while(!devoUscire) {
			...
			if (c.equals("q")) {
				...
				System.out.println("Incasso: Ä " + negozio.getIncasso());
				...
				int pos = sc.nextInt();
				Prodotti pr = negozio.vendiProdotto(pos);
				System.out.println("Hai acquistato " + pr.getNome() + " per Ä " + pr.getPrezzo());
				...
				Prodotti prodotto = new Prodotti(n, p);
