...
public class Car {
	...
	/**
	 * 
	 * Progettare e realizzare una classe Car(automobile) con le proprieta` seguenti. 
	 * Uníautomobile ha una determinata resa del carburante 
	 * (misurata in miglia/galloni o in litri/chilometri: scegliete il sistema che preferite) 
	 * e una certa quantita` di carburante nel serbatoio. 
	 * La resa e` specificata dal costruttore e il livello iniziale del carburante e` a zero. 
	 * Fornire questi metodi: un metodo drive per simulare il percorso 
	 * di uníautomobile per una certa distanza, riducendo il livello di carburante nel serbatoio; 
	 * un metodo getGas, per ispezionare il livello corrente del carburante; 
	 * un metodo addGas per far rifornimento.
	 * Consigli:
	 * Síinvita a porre particolare attenzione al metodo drive(double km), 
